...
public class CertificateOfBirthDataFilterDeclineByDistrictOfficer implements CertificateOfBirthDataFilter {
    @Override
    public List<CertificateOfBirthData> filter(List<CertificateOfBirthData> certificateOfBirthDatas) {
        ...
        for (CertificateOfBirthData data : certificateOfBirthDatas){
            if (data.geteCertificateOfBirthState() == ECertificateOfBirthState.DeclineByDistrictOfficer){
